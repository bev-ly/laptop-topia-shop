  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="bg-gray-50 rounded-md p-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="text-gray-900">${(order.total / 1.1).toFixed(2)}</span>
              </div>
              <div className="flex justify-between text-sm">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-gray-900">${(order.total - order.total / 1.1).toFixed(2)}</span>
              </div>
        ...
        {/* Footer */}
        <div className="bg-gray-50 p-6 border-t flex flex-col sm:flex-row gap-4 justify-center sm:justify-between">
